            ...
            <div class="card-body py-3">
                <form method="POST" action="{{ route('employee.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row  align-items-center">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                {!! Form::text('password', null, ['class' => 'form-control form-control-lg form-control-solid', 'required']) !!}
                            </div>
                        </div>
                        @error('password')
                            <small class="form-text text-danger">{{ $message }}</small>
                    ...
                    <div class="row  align-items-center">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                {!! Form::select('department_id', $departments, ['class' => 'form-control form-control-lg form-control-solid']) !!}
                            </div>
                        </div>
                        @error('department_id')
                            <small class="form-text text-danger">{{ $message }}</small>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                {!! Form::file('file', null, ['class' => 'form-control form-control-lg form-control-solid', 'required']) !!}
                            </div>
                        </div>
                        @error('image')
                            <small class="form-text text-danger">{{ $message }}</small>
